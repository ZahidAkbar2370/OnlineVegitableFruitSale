                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-item">
                            ...
                            <a href="{{ url('about-us') }}" class="btn border-secondary py-2 px-4 rounded-pill text-primary">Read More</a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 my-auto text-center text-md-end text-white">
                        Designed & Developed By <a class="border-bottom" href="#">Arshad</a>
                    </div>
                </div>
            </div>
        </div>
